<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="ZWard2.aspx.cs" Inherits="GarbageMaster.Pages.ZWard2" Async="true"%>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <link href="../wwwroot/css/maps.css" rel="stylesheet" /><script src="../wwwroot/js/CDNs/sweetalert2.all.min.js"></script><script src="../wwwroot/js/Alerts.js"></script><script src="../wwwroot/js/CDNs/sweetalert2.all.min.js"></script><script src="../wwwroot/js/Alerts.js"></script>
    <style>
        .mytruck2{
            color:black;
            border:1px solid;
